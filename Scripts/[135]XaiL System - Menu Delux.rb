...
module XAIL
  module MENU_DELUX
    ...
    MENU_LIST = {
      :item      => ["Gegenstände", "Ve tus objetos obtenidos.", 264, true, false],
      :equip     => ["Ausrüstung", "Cambia tu equipo.", 436, true, true],
      :skill     => ["Fähigkeiten", "Administra tus habilidades.", 143, true, true],
      :status    => ["Status", "Ve el estado actual de los heroes.", 121, true, true],
      #:formation => ["Formación", "Cambia la formación del grupo.", 12, true, false],
      :title     => ["Test", "Regresar al título.", 4133, true, false, Soul_Orpheus_Reputation],
      #:save      => ["Guardar", "Guarda tu progreso.", 4139, true, false],
      #:load      => ["Cargar", "Carga tu proyecto.", 4165, true, false, Scene_Load],
      :game_end  => ["Beenden", "Salir del Juego.", 4162, true, false],
